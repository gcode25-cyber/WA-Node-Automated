...
- Real-time chat management improvements (August 2025): Enhanced chat deletion to immediately hide chats from website interface without phone-side operations (no archiving), chat clearing updates website interface instantly in real-time, background processing handles WhatsApp operations without blocking user experience
